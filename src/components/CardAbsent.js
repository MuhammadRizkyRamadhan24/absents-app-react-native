...
export default function CardAbsent(props) {
  return (
    <View style={styles.card}>
      <View style={styles.wrapperTime}>
        <Text style={styles.textTime}>{props.data.absent.split('T')[0]}</Text>
      </View>
      <View style={styles.wrapperCardContent}>
        ...
        <View style={styles.wrapperCardText}>
          ...
          <Text style={styles.textType}>
            {props.data.type === 'masuk' ? 'Masuk' : 'Pulang'}
          </Text>
          <Text style={styles.textLate}>Terlambat : {props.data.late}</Text>
        </View>
      </View>
    </View>
  );
